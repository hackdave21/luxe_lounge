        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-blue-600">
                    <h3 class="card-title text-green">Modifier le plat</h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('plats.update', $plat->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="prix" name="prix"
                                    value="{{ old('prix', $plat->prix) }}" placeholder="2500" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="form-control" id="categorie_id" name="categorie_id" required>
                                ...
                                @foreach($categories as $categorie)
                                    <option value="{{ $categorie->id }}" {{ (old('categorie_id', $plat->categorie_id) == $categorie->id) ? 'selected' : '' }}>
                                        {{ $categorie->nom }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="5"
                                placeholder="Décrivez les ingrédients et la préparation du plat...">{{ old('description', $plat->description) }}</textarea>
                        ...
                        <div class="form-group mt-3">
                            ...
                            @if($plat->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $plat->image) }}" alt="{{ $plat->nom }}" class="img-thumbnail" style="max-height: 150px;">
                                </div>
                            @endif
