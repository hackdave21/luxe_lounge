        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-blue-600">
                    <h3 class="card-title text-green">Détails du plat : {{ $plat->nom }}</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- Image à gauche -->
                        <div class="col-md-4">
                            @if($plat->image)
                                <div class="text-center mb-3">
                                    <img src="{{ Storage::url($plat->image) }}" alt="{{ $plat->nom }}" class="img-fluid rounded" style="max-height: 300px;">
                                </div>
                            @else
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-9">{{ $plat->nom }}</div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-md-3 fw-bold">Prix :</div>
                                        <div class="col-md-9">{{ number_format($plat->prix) }} FCFA</div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-md-3 fw-bold">Catégorie :</div>
                                        <div class="col-md-9">{{ $plat->categorie->nom }}</div>
                                    </div>
                                    <div class="row mb-2">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-9">{{ $plat->id }}</div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-md-3 fw-bold">Date de création :</div>
                                        <div class="col-md-9">{{ $plat->created_at->format('d/m/Y H:i') }}</div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-md-3 fw-bold">Dernière modification :</div>
                                        <div class="col-md-9">{{ $plat->updated_at->format('d/m/Y H:i') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-4">
                        <a href="{{ route('plats.edit', $plat->id) }}" class="btn btn-primary">
                            <i class="fa fa-edit"></i> Modifier
                        </a>
                        <a href="{{ route('plats.index') }}" class="btn btn-secondary">
